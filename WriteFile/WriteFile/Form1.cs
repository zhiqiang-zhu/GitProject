    ...
    public partial class Form1 : Form
    {
        ...
        private void SaveDataReport()
        {
            ...
            */
            ...
            string s5 = String.Format("<tr>	<td>备注</td>	<td colspan=\"2\"></td>	<td></td>	<td></td>	<td></td>  </tr>");

            string s6 = "<style>table,th,td {border:1px solid black; border-collapse:collapse;}" + 
                        "caption{font-size:18px; padding-bottom:4px;}" + 
                        ".tab{font-size:16px;text-align:center;color:black;}</style>";
